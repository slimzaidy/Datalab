...
preprocess_pipeline = Pipeline([
    ("email_to_wordcount", CountVectorizer(analyzer = 'word', ngram_range = (1, 1))), #lowercase = True, max_df = 0.25, 
...
for i in range(0, 3): #len(names))
    ...
    #content= re.sub(r'\W+', ' ', content, flags=re.M)
...
contents = preprocess_pipeline.fit_transform(contents)
print(contents[0])
...
#X_test_transformed_testset = preprocess_pipeline.transform(contents)
